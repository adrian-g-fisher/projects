...
titles = ["Emu exclousre", "Outside Emu",
          "Conservation exclosure", "Outside Conservation",
          "Warrens exclosure", "Outside Warrens"]          

# Plot green and dead cover over time for the six sites
fig = plt.figure(1)
fig.set_size_inches((8, 10))
rects  = [[0.1, 0.85, 0.85, 0.14],
          [0.1, 0.69, 0.85, 0.14],
          [0.1, 0.53, 0.85, 0.14],
          [0.1, 0.37, 0.85, 0.14],
          [0.1, 0.21, 0.85, 0.14],
...
for i in range(6):
    ...
    ax.set_ylim((0, 80))
    ax.text(datetime.date(1988, month=6, day=1), 68, titles[i], fontsize=14)
...
plt.savefig(r'exclosure_timeseries.png', dpi=300)