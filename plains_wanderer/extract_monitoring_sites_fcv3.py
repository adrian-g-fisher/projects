...
This extracts fractional cover data for the Plains Wanderer monitoring sites
...
# Get imageList
imageDir = r'S:\hay_plain\landsat\landsat_seasonal_fractional_cover_version3'
imageList = glob.glob(os.path.join(imageDir, '*.tif'))

# Write the csvfile header
csvfile = r'C:\Users\z9803884\OneDrive - UNSW\Documents\student_projects\phd\rachael_loneragan\site_polygons_fractional_cover'
...
polyfile = (r'C:\Users\z9803884\OneDrive - UNSW\Documents\student_projects\phd\rachael_loneragan\site_polygons_fractional_cover\PW_monitoring_sites_merged_epsg3577.shp')
