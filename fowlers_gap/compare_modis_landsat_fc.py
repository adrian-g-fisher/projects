...
fig.text(0.075, 0.91, 'Monthly timeseries')
...
axLeg = plt.axes([0, 0, 1, 0.02], frameon=False)
...
axLeg.text(24, 1.2, r'Photosynthetic vegetation')
axLeg.plot([57, 58], [2, 2], ls='-', c='saddlebrown', lw=2, alpha=0.5)
axLeg.text(59, 1.2, r'Non-photosynthetic vegetation')
