...
inDir = r'C:\Users\z9803884\OneDrive - UNSW\Documents\witchelina\awp_grazing_pressure\4_including_neighbours'
awp_shapefile = os.path.join(inDir, r'awp_epsg3577.shp')
paradise_shapefile = os.path.join(inDir, r'paradise_total_epsg3577.shp')
paddock_shapefile = os.path.join(inDir, r'paradise_paddocks_epsg3577.shp')
paddock_buffer = os.path.join(inDir, r'paradise_paddocks_buffer100m_epsg3577.shp') # 100 m buffer
