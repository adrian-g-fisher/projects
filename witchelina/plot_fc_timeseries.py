...
titles = ["Stony flat (Id=1)", "Stony flat (Id=2)",
          "Stony downs (Id=3)", "Stony downs (Id=4)",
          "Farina Road (Id=5)", "Farina Road (Id=6)"]          
...
for i in range(6):
    ...
    ax.set_ylim((0, 75))
    ax.text(datetime.date(1988, month=6, day=1), 60, titles[i], fontsize=14)
...
plt.savefig(r'timeseries.png', dpi=300)