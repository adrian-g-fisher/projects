...
def make_plot(csvfile, sumFile):
    ...
    axGreen.text(1988.5, 35, 'Photosynthetic vegetation (PV)', fontsize=12, horizontalalignment="left")
    ...
    axDead.text(1988.5, 70, 'Non-photosynthetic vegetation (PV)', fontsize=12, horizontalalignment="left")
...
with open(sumFile, 'w') as f:
    f.write('Id,Ident,date,droneAlive,droneDead,satPV,satNPV,satBare\n')
